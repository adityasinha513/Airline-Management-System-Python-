...
admin = {'admin': 'admin','aditya':'aditya'}
manager = {'manager': 'manager'}
standard = {'standard': 'standard','kshitiz':'kshitiz'}
scheduled = {'AI 0946': ["10:10", 'Mumbai', "Delayed"], '9I 0506': ['5:30', 'Bangaluru', 'Delayed'],
             '9I 0102': ['1:49', 'Pune', 'Scheduled'], 'AI 0018': ['7:40', 'New Delhi', 'Scheduled'],
             'AI 0744': ['2:50', 'Kolkata', 'Delayed'], 'AI 0640': ['9:320', 'Chandigarh', 'Scheduled'],
             'AI 0982': ['8:40', 'Chennai City', 'Scheduled']}
cancelled = {'9I 0337': ["3:00", "Prayagraj City", "Cancelled"]}
